        ...
        <section id="Modalidade" className="w-full relative h-full">
                <div className="max-w-[1800px] h-full text-justify mx-auto p-5 md:px-10 md:pb-10 pt-30">
                    ...
                    <div className="flex flex-col md:flex-row gap-5 w-full items-center md:justify-evenly md:items-start">
                        ...
                        <div className="flex flex-col bg-[#1F1F1F]/40 rounded-xl w-full h-full p-3 max-w-100">
                            <div className="relative overflow-hidden w-full rounded-lg">
                                <div className="w-full h-fit">
                                    <img src="assets/boxeEducativo.png" alt="Boxe Educativo" className="w-full !max-w-none max-h-80" />
                                </div>
                        ...
                        <div className="flex flex-col bg-[#1F1F1F]/40 rounded-xl w-full h-fit p-3 max-w-100">
                            <div className="relative overflow-hidden w-full rounded-lg">
                                <div className="w-full h-fit">
                                    <img src="assets/boxeManutencao.png" alt="Boxe Educativo" className="w-full !max-w-none max-h-80" />
                                </div>
                        ...
                        <div className="flex flex-col bg-[#1F1F1F]/40 rounded-xl w-full h-full p-3 max-w-100">
                            <div className="relative overflow-hidden w-full rounded-lg">
                                <div className="w-full h-fit">
                                    <img src="assets/boxeCompeticao.png" alt="Boxe Competição" className="w-full !max-w-none max-h-80" />
                                </div>
