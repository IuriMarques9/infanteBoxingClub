    ...
    return (
        <div className="overflow-hidden w-full">
            <Image
                ...
                width={400}
                height={400}
                className="shadow w-full h-full object-contain hover:cursor-pointer hover:brightness-70"
...

            {
                ...
                (<div className="fixed top-0 right-0 w-full h-screen bg-black/80 z-99 flex flex-col justify-center items-center">
                    ...
                    <a download href={props.url} className="absolute bottom-8 p-2 bg-[#EAEAEA] hover:opacity-90 cursor-pointer mx-auto flex gap-2 items-center text-[#CCA158]">
