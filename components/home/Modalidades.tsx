            ...
            <div className="container mx-auto px-4">
              ...
              <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8">
                <Card className="overflow-hidden">
                  {competitionBoxingImg && <Image src={competitionBoxingImg.imageUrl} alt={competitionBoxingImg.description} width={400} height={300} className="w-full h-48 object-cover" data-ai-hint={competitionBoxingImg.imageHint}/>}
                  <CardHeader>
